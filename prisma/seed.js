...
var encrypters_1 = require("@/helpers/encrypters");
var client_1 = require("@prisma/client");
var prismaClient = new client_1.PrismaClient();
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var password, name, hashedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    hashedPassword = (0, encrypters_1.default)(password);
                ...
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2: throw "check default username and password in .env file";
