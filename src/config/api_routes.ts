...
export const RESERVATION_API_ROUTE: string = `${MAIN_API_ROUTE}/reservation`;
export const ORDER_API_ROUTE: string = `${MAIN_API_ROUTE}/order`;
export const ITEM_GROUP_API_ROUTE: string = `${MAIN_API_ROUTE}/item_group`;
export const ITEM_API_ROUTE: string = `${MAIN_API_ROUTE}/item`;
export const NOTIFICATION_API_ROUTE: string = `${MAIN_API_ROUTE}/notifications`;
export const USER_API_ROUTE: string = `${MAIN_API_ROUTE}/user`;
export const SETTINGS_API_ROUTE: string = `${MAIN_API_ROUTE}/settings`;
export const ROOM_API_ROUTE: string = `${MAIN_API_ROUTE}/room`;
