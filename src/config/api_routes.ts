...
export const NEWS_API_ROUTE: string = `${MAIN_API_ROUTE}/news`;
export const REPORTS_API_ROUTE: string = `${MAIN_API_ROUTE}/reports`;
...
export const REPORT_USER_API_ROUTE: string = `${MAIN_API_ROUTE}/report`;
