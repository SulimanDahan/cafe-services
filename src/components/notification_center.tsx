 ...
 */
 ...
 {isOpen && (
 <div
 className={`absolute mt-3 w-[calc(100vw-2rem)] sm:w-96 max-w-sm rounded-3xl border border-white/15 shadow-2xl bg-surface/95 backdrop-blur-2xl text-white overflow-hidden transition-all duration-300 shadow-black ${
 isRtl
