    ...
    return (
        <div className="relative z-50 font-sans" dir={isRtl ? "rtl" : "ltr"}>
            ...
            <div ref={dropdownRef} className="relative">
                ...
                {isOpen && (
                    <div
                        className={`absolute mt-3 w-[calc(100vw-2rem)] sm:w-96 max-w-sm rounded-3xl border border-white/15 shadow-2xl bg-[#131522]/95 backdrop-blur-2xl text-white overflow-hidden transition-all duration-300 transform scale-100 shadow-black ${
                            isRtl
                        ...
                        {unreadCount > 0 && (
                            <div className="p-4 bg-white/2 border-t border-white/10 text-center">
                                <button
                                    ...
                                    className="text-xs font-black text-amber-300 hover:text-amber-100 transition-colors cursor-pointer w-full py-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 active:scale-95 border border-amber-500/20 shadow-sm"
                                >
