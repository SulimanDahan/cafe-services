...
export default function MetricCard({
  ...
  return (
    <div className="rounded-[28px] border border-white/10 bg-[#131522] p-5 sm:p-6 flex flex-col justify-between shadow-md h-full gap-4 min-h-35">
      <div className="flex justify-between items-start gap-3">
        ...
        {icon && (
          <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-400 flex items-center justify-center shrink-0">
            {icon}
          </div>
        )}
      </div>
