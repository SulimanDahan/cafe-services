    ...
    return (
        <div className="space-y-6 w-full" dir={isRtl ? "rtl" : "ltr"}>
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#131522] p-8 shadow-2xl backdrop-blur-xl">
                ...
                <div
                    className={`absolute top-0 ${isRtl ? "left-0 -ml-16" : "right-0 -mr-16"} -mt-16 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl pointer-events-none`}
                />
                <div
                    className={`absolute bottom-0 ${isRtl ? "right-0 -mr-16" : "left-0 -ml-16"} -mb-16 w-64 h-64 bg-amber-500/5 rounded-full blur-3xl pointer-events-none`}
                />
            ...
            <form onSubmit={handleSubmit(handleSaveAll)} className="space-y-6">
                ...
                <div
                    className={`rounded-[28px] border border-white/10 bg-[#131522]/80 p-8 shadow-2xl backdrop-blur-xl space-y-6 ${activeTab === "system" ? "block" : "hidden"}`}
                >
                    <div
                        className={`flex items-center gap-3 pb-4 border-b border-white/10 ${isRtl ? "border-r-4 border-r-amber-500 pr-3" : "border-l-4 border-l-amber-500 pl-3"}`}
                    >
                            ...
                            <div className="space-y-2">
                                ...
                                {errors.currency_name?.message && (
                                    <p className="text-[10px] text-red-400 font-medium mt-1">
                                        {String(errors.currency_name.message)}
                                    </p>
                                )}
                            </div>
                        ...
                        <div className="space-y-2 bg-[#07080a]/50 p-5 rounded-2xl border border-white/5 hover:border-white/10 transition-all duration-300 flex flex-col justify-between">
                            <div className="space-y-2">
                                ...
                                {errors.app_lang?.message && (
                                    <p className="text-[10px] text-red-400 font-medium mt-1">
                                        {String(errors.app_lang.message)}
                                    </p>
                                )}
                            </div>
                            <span className="text-[10px] text-zinc-500 font-bold block mt-3 leading-normal border-t border-white/5 pt-2">
                        ...
                        <div className="space-y-2 bg-[#07080a]/50 p-5 rounded-2xl border border-white/5 hover:border-white/10 transition-all duration-300 flex flex-col justify-between">
                            <div className="space-y-2">
                                ...
                                {errors.per_page?.message && (
                                    <p className="text-[10px] text-red-400 font-medium mt-1">
                                        {String(errors.per_page.message)}
                                    </p>
                                )}
                            </div>
                            <span className="text-[10px] text-zinc-500 font-bold block mt-3 leading-normal border-t border-white/5 pt-2">
                ...
                <div
                    className={`rounded-[28px] border border-white/10 bg-[#131522]/80 p-8 shadow-2xl backdrop-blur-xl space-y-6 ${activeTab === "security" ? "block" : "hidden"}`}
                >
                    <div
                        className={`flex items-center gap-3 pb-4 border-b border-white/10 ${isRtl ? "border-r-4 border-r-amber-500 pr-3" : "border-l-4 border-l-amber-500 pl-3"}`}
                    >
                        ...
                        <div className="space-y-2 bg-[#07080a]/50 p-5 rounded-2xl border border-white/5 hover:border-white/10 transition-all duration-300 flex flex-col justify-between">
                            <div className="space-y-2">
                                ...
                                <div className="relative flex items-center mt-1">
                                    ...
                                    />
                                    <span
                                        className={`absolute ${isRtl ? "left-4" : "right-4"} text-xs font-black text-amber-400 pointer-events-none`}
                                    >
