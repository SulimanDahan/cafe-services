                ...
                <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 mb-6 pb-4 border-b border-white/5">
                    ...
                    <TabBar
                        tabs={[
                            ...
                            {
                                id: "pending",
                                label: `${t("reservations.filterPending")} (${stats?.pendingReservations ?? 0})`,
                            },
                            {
                                id: "confirmed",
                                label: `${t("reservations.filterAccepted")} (${stats?.acceptedReservations ?? 0})`,
                            },
                        ]}
                        activeTab={activeTab}
                        onChange={(id) =>
                            setActiveTab(id as "all" | "pending" | "confirmed")
                        }
                    />
                        ...
                        <thead>
                            ...
                            >
                                <th className="pb-3 px-4 whitespace-nowrap">
                                    {t("dashboard.columnNumber")}
                                </th>
                                <th className="pb-3 px-4 whitespace-nowrap">
                                    {t("dashboard.columnClient")}
                                </th>
                                <th className="pb-3 px-4 whitespace-nowrap">
                                    {t("dashboard.columnRoom")}
                                </th>
                                <th className="pb-3 px-4 whitespace-nowrap">
                                    {t("dashboard.columnDateTime")}
                                </th>
                            ...
                            {isLoading ? (
                                ...
                                filteredReservations.map((res) => (
                                    ...
                                    >
                                        ...
                                        <td
                                            className={`py-4 px-4 font-semibold text-zinc-300 text-xs whitespace-nowrap ${isRtl ? "text-right" : "text-left"}`}
                                        >
                                            {res.room?.name ??
                                                t("common.unknown")}
                                        </td>
                                        ...
                                        <td className="py-4 px-4 text-center whitespace-nowrap">
                                            ...
                                            >
                                                <span
                                                    className={`w-1.5 h-1.5 rounded-full ${res.accepted ? "bg-green-400" : "bg-amber-400 animate-pulse"}`}
                                                />
                                                {res.accepted
                                                    ? t(
