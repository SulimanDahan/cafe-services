...
export default function AdminLayout({ children }: LayoutProps) {
 ...
 <ReservationProvider>
 <div
 className="h-screen max-h-screen overflow-hidden bg-background text-zinc-100 font-sans flex flex-row"
 dir={isRtl ? "rtl" : "ltr"}
 >
 ...
 <aside
 className={`lg:hidden fixed top-0 bottom-0 z-50 transition- duration-300 h-screen shrink-0 w-64 border-white/10 ${
 isRtl
 ? "right-0 border-l"
 : "left-0 border-r"
 } ${
