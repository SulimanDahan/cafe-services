        ...
        <div className="space-y-6">
                                    ...
                                    <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                                        {resOrders.length > 0 ? (
                                            resOrders.map((o) => (
                                                <div
                                                    key={o.id}
                                                    className="p-3 rounded-2xl bg-[#07080a]/50 border border-white/5 flex justify-between items-center text-xs gap-3"
                                                >
                                                    ...
                                                    <div className="flex items-center gap-3 shrink-0">
                                                        ...
                                                        {o.accepted ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className="px-3 py-1 rounded-full bg-amber-500 hover:bg-amber-400 text-[#07080a] font-extrabold text-[9px] transition-all active:scale-95 cursor-pointer shadow-sm shadow-amber-500/10"
                                                            >
                                                                {t(
                                                                    "orders.btnApprove",
                                                                )}
            ...
            {toast && (
                <div className="fixed bottom-6 left-6 right-6 sm:left-auto sm:max-w-md z-50 animate-bounce">
                    <div
                        className={`rounded-2xl border px-5 py-4 shadow-2xl backdrop-blur-xl flex items-center justify-between gap-4 ${toast.isError ? "bg-red-500/10 border-red-500/30 text-red-300" : "bg-amber-500/10 border-amber-500/30 text-amber-300"}`}
                    >
                        <div className="flex items-center gap-3">
                            <span
                                className={`h-6 w-6 rounded-lg flex items-center justify-center font-black text-xs border ${toast.isError ? "bg-red-500/20 border-red-500/30" : "bg-amber-500/20 border-amber-500/30"}`}
                            >
                                {toast.isError ? "✕" : "✓"}
                            </span>
